  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: t("supplierUpdatedDescription").replace("{name}", formData.name),
      })
    ...
    <PageAnimation>
      <div className="space-y-6">
        <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm border">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">{t("editSupplier")}</h2>
            <p className="text-muted-foreground text-sm">{t("editSupplierDescription")}</p>
          </div>
        </div>
